...
function SearchFrom() {
	...
	return (
		<form className="relative flex" onSubmit={submitHandler}>
			<input
				className="w-80 appearance-none rounded border-none bg-slate-200 dark:bg-neutral-900 p-2.5 pr-10 text-sm text-gray-600 dark:text-white outline-none placeholder:text-gray-500 placeholder:transition-colors focus:text-gray-600 focus:placeholder:text-gray-400 dark:focus:placeholder:text-white"
				type="text"
				placeholder="Search..."
				ref={searchInput}
